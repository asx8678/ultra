...
func TestFabricExecPublishesLivePhaseAndCallActivity(t *testing.T) {
	...
	require.Equal(t, 1, activities[0].InputSchemas)
	require.Zero(t, activities[0].OutputSchemas)
	require.Equal(t, map[RiskClass]int{RiskWrite: 1}, activities[0].RiskCounts)
