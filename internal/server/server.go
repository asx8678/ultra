...
func (s *Server) installHandler() {
	...
	mux.HandleFunc("GET /v1/workspaces/{id}/config/custom-providers", c.handleGetWorkspaceCustomProviders)
	mux.HandleFunc("POST /v1/workspaces/{id}/config/custom-providers/discover", c.handlePostWorkspaceCustomProviderDiscover)
	mux.HandleFunc("POST /v1/workspaces/{id}/config/custom-providers/save", c.handlePostWorkspaceCustomProviderSave)
	mux.HandleFunc("POST /v1/workspaces/{id}/config/custom-providers/delete", c.handlePostWorkspaceCustomProviderDelete)
